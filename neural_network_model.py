...
class Model(object):
    ...
    def forward_propagation(self, x):
        ...
        #######################################################################
        "*** YOUR CODE HERE ***"
        # w = nn.parameter.zeros([784, 10])
        # b = nn.parameter.zeros([10])
        #logits = None
    ...
    def get_loss(self, x, y):
        ...
        Inputs:
            x: a batch with hape [batch_size, 1, 28, 28]
        ...
        loss, entropy = nn.cross_entropy_loss(logits=logits, labels=y)
        probs = entropy.probs
        #######################################################################
